...
const calibrateTargetLogAndSigma = (targetLogGrowthMonthly, sigmaMonthly, shockGrid = buildDeterministicStudentTShockGrid(8193)) => {
...
const buildMuCalibrationCurve = (generalParameters, scenarioParameters, step, shockGrid) => {
    ...
    for (let intensity = 0; intensity <= 1 + 1e-12; intensity += step) {
        ...
        const muMonthly = (0, exports.calibrateTargetLogAndSigma)(targetLogGrowthMonthly, sigmaMonthly, shockGrid);
