...
export const calibrateMonthlyLocation = (targetAnnualCagr: number, annualVolatility: number): number => {
...
export const precomputeEtfScenarioParameters = (statistics: MonteCarloEtfStatistics): PreparedEtfScenarioParameters => {
