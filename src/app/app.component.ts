...
type NavItemId = 'portafogli' | 'portfolio' | 'correlations' | 'montecarlo' | 'backtesting' | 'new-etf' | 'settings';
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, PortafoliPageComponent, PortfolioPageComponent, CorrelationsPageComponent, MontecarloPageComponent, BacktestingPageComponent, NewEtfPageComponent, SettingsPageComponent],
  templateUrl: './app.component.html',
  styleUrls: ['./app.component.css']
})
export class AppComponent {
  readonly navItems: NavItem[] = [
    { id: 'portafogli', label: 'Portafogli', description: 'Gestione portafogli', icon: '◌' },
  ...
  activePage = signal<NavItemId>('portafogli');
